...
const SideBar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    >
      ...
      {/* New Chat Button */}
      <button className="flex justify-center items-center w-full py-2 mt-10 text-white bg-gradient-to-r from-[#A456F7] to-[#3D81F6] text-sm rounded-mmd cursor-pointer">
